...
\frame{
	...
	\begin{columns}
		...
		\item V 10 M HCl vznikají oktaedrické ionty \ce{RfCl$_6^{2-}$}.
	\end{itemize}
	\end{column}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Titan patří mezi hojně rozšířené prvky, jeho koncentrace v zemské kůře je 6320~ppm.
	...
	\begin{columns}
		...
		\begin{figure}
			\adjincludegraphics[height=.5\textheight]{img/Titanium_products.jpg}
		\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.3\textheight]{img/Ilmenite-173863.jpg}
		\adjincludegraphics[height=.3\textheight]{img/Ilmenite-Cassiterite-Quartz-130337.jpg}
		\adjincludegraphics[height=.3\textheight]{img/Ilmenit-Struktur.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.25\textheight]{img/Rutile_et_hématite.jpg}
		\adjincludegraphics[height=.25\textheight]{img/Hematite-Rutile-57088.jpg}
		\adjincludegraphics[height=.25\textheight]{img/Rutile-unit-cell-3D-balls.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.45\textheight]{img/Perovskite-155026.jpg}
		\adjincludegraphics[height=.45\textheight]{img/Kristallstruktur_Perovskit.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item V roce 1940 tento postup nahrazen ekonomičtějším \textit{Krollovým procesem}, který vyvinul lucembruský metalurg William J. Kroll.\footnote[frame]{\href{https://www.youtube.com/watch?v=41yjeguApo4}{How Do They Do It? Titanium.}}
		\item Místo sodíku probíhá redukce taveninou hořčíku v atmosféře argonu:
		\item \ce{TiCl4 + 2 Mg ->[950 $^\circ$C] Ti + 2 MgCl2}
		\item Chlorid titaničitý je získávám zahříváním ilmenitu nebo rutilu s koksem v proudu chloru:\footnote[frame]{\href{https://dx.doi.org/10.22063/poj.2017.1453}{Production of titanium tetrachloride (\ce{TiCl4}) from titanium ores: A review}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Následně se redukuje taveninou hořčíku (T$_t$ = 650~$^\circ$C) v uzavřeném reaktoru v atmosféře argonu.
		\item \ce{TiCl4 + 2 Mg ->[950-1150 $^\circ$C] Ti + 2 MgCl2}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Krollovým proces získáme tzv. \textit{titanovou houbu}, která se musí dále zpracovat na ingoty.
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.7\textheight]{img/Titanium-cylinder.jpg}
		\caption*{Titanová houba}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item \textbf{FFC Cambridge Process} -- Fray-Farthing-Chem
		...
		\item Elektrolýza probíhá při teplotě 550--850~$^\circ$C, jako rozpouštědlo se využívá zpravidla chlorid vápenatý (T$_t$ = 772~$^\circ$C).
...
\frame{
	...
	\end{itemize}
		...
		\begin{column}{.6\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.5\textheight]{img/Zirconium_crystal_bar.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.7\textheight]{img/Zirconium_mineral_concentrates_-_world_production_trend.png}
		\caption*{Světová produkce minerálů zirkonu}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item \textbf{Zirkon}\footnote[frame]{\href{https://mineraly.sci.muni.cz/nesosilikaty/zirkon.html}{Zirkon}}
		\item \ce{ZrSiO4}, tetragonální minerál.\footnote[frame]{\href{https://www.mindat.org/min-4421.html}{Zircon}}
		\item Patří do skupiny nesosilikátů a jde o jeden z hlavních zdrojů pro výrobu kovového zirkonia.
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/Zircon-59684.jpg}
		\adjincludegraphics[height=.4\textheight]{img/Aegirine-Zircon-Feldspar-Group-238900.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.55\textheight]{img/Baddeleyite-md12a.jpg}
		\adjincludegraphics[height=.55\textheight]{img/BaddeleyiteStructure.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/Van-Arkel-de-Boer-Apparat.png}
		\caption*{1 - přívod vakua; 2 - molybdenová elektroda; 3 - molybdenová síť; 4 - zásobník surového materiálu; 5 - wolframové vlákno}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\end{itemize}
	\item Má pět stabilních izotopů: \ce{^{176}Hf}, \ce{^{177}Hf}, \ce{^{178}Hf}, \ce{^{179}Hf} a \ce{^{180}Hf}.
	\end{itemize}
	\begin{columns}
		\begin{column}{.2\textwidth}
			\begin{tabular}{|l|r@{,}l|}
				\hline
				\ce{^{176}Hf} & 5 & 26 \% \\\hline
				\ce{^{177}Hf} & 18 & 60 \% \\\hline
				\ce{^{178}Hf} & 27 & 28 \% \\\hline
				\ce{^{179}Hf} & 13 & 62 \% \\\hline
				\ce{^{180}Hf} & 35 & 08 \% \\\hline
			\end{tabular}
		\end{column}
		\begin{column}{.6\textwidth}
		\begin{figure}
			\adjincludegraphics[height=.4\textheight]{img/Hafnium_ebeam_remelted.jpg}
		\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.3\textheight]{img/Hafnium_pellets_with_a_thin_oxide_layer.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{Zr + O2 -> ZrO2}
		\item Palivové tyče pro jaderné reaktory se potahují ochranou vrstvou kovového zirkonia.
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.3\textheight]{img/Zr-getter.jpg}
		\adjincludegraphics[height=.3\textheight]{img/Rotor_ssNMR.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Izotop \ce{^{89}Zr} se využívá při diagnostice nádorů pomocí PET (pozitronové emisní tomografie).
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=\textwidth]{img/ZNonSingleSite.png}
	\end{figure}
	\vfill
}
	...
	\begin{columns}
		...
		\begin{column}{0.3\textwidth}
			\begin{center}
				...
				\vspace{2mm}
				\adjincludegraphics[width=0.6\textwidth]{img/TiCl4-2THF.png}
			\end{center}
		\end{column}
	\end{columns}
}
	...
	\begin{columns}
		...
		\begin{column}{0.2\textwidth}
			\begin{center}
				...
				\adjincludegraphics[width=0.8\textwidth]{img/TiCl3.jpg}
			\end{center}
		\end{column}
	\end{columns}
}
	...
	\begin{columns}
		\begin{column}{0.8\textwidth}
			...
			\begin{itemize}
				...
				\item V nanoskopické podobě má fotokatalytické vlastnosti.
			\end{itemize}
			\vfill
		\end{column}
		\begin{column}{0.3\textwidth}
			\begin{center}
				Rutil:
				\adjincludegraphics[width=0.8\textwidth]{img/Rutile_crystal_structure.png}

				\vspace{2mm}
				Anatas:
				\adjincludegraphics[width=0.8\textwidth]{img/Anatase_crystal_structure.png}
			\end{center}
		\end{column}
	\end{columns}
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Vznikají síran železitý je redukován železnýma hoblinama.
		\item Zelená skalice je po ochlazení odfiltrována.
		\item Síran titanylu je redukován varem ve vodě za vzniku gelu \ce{TiO2}:
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{0.4\textwidth}
			\begin{center}
				\adjincludegraphics[width=\textwidth]{img/One_World_Trade_Center_and_7_World_Trade_Center,_Manhattan,_July_2019.jpg}
			\end{center}
		\end{column}
	\end{columns}
}
	...
	\begin{columns}
		\begin{column}{0.8\textwidth}
			...
			\begin{itemize}
				...
				\end{itemize}
				\item Příkladem mohou být fluorované polymery.\footnotemark
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{0.3\textwidth}
			\begin{center}
				\adjincludegraphics[width=\textwidth]{img/Titanium_dioxide.jpg}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{0.7\textwidth}
			\begin{center}
				\adjincludegraphics[width=0.9\textwidth]{img/CatalysisScheme.png}
			\end{center}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{center}
		...
		\adjincludegraphics[width=0.2\textwidth]{img/Photochemical_immersion_well_reactor_750_mL.jpg}
	\end{center}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{0.4\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/ZrO2.png}
				\adjincludegraphics[width=.6\textwidth]{img/CZ_brilliant.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{0.4\textwidth}
			\begin{center}
				\adjincludegraphics[width=\textwidth]{img/ZrN-polyhedral.png}
				\adjincludegraphics[width=.9\textwidth]{img/Zirconium_carbide_ZrC.jpg}
			\end{center}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.3\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Titanium-nitride-crystal-3D-vdW.png}
			\end{figure}
		\end{column}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.4\textheight]{img/Titanium_nitride_TiN.jpg}
			\end{figure}
		\end{column}
		\begin{column}{.1\textwidth}
		\begin{figure}
			\adjincludegraphics[height=.4\textheight]{img/Titanium_nitride_coating.jpg}
		\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{figure}
		\adjincludegraphics[height=.3\textheight]{img/Zirconiun_nitride_coated_cutters.jpg}
		\caption*{Frézy s povrchovou vrstvou ZrN}
	\end{figure}
	\vfill
}
